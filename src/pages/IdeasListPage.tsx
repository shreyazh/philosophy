...
export function IdeasListPage() {
  ...
  const schools = ['All', ...allSchools.filter(s => ideaSchoolIds.has(s.id)).map(s => s.name).sort()];
    ...
    <div className="min-h-screen bg-gray-50 max-w-6xl mx-auto w-full">
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Philosophical Ideas</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the fundamental concepts that have shaped human understanding
          </p>
        </div>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      {originSchool && (
                        <p className="text-sm text-gray-600">{originSchool.name}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-gray-800 text-sm mb-2">Modern Applications:</h4>
                      <div className="flex flex-wrap gap-1">
                        {idea.modernApplications.slice(0, 2).map((app, index) => (
        ...
        {filteredIdeas.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No ideas match your current filters.</p>
