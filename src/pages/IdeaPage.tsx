...
import { ArrowLeft, Lightbulb, Users, BookOpen, ExternalLink, Target, Zap } from 'lucide-react';
...
export function IdeaPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/ideas" className="text-blue-600 hover:text-blue-800">Return to Ideas</Link>
        </div>
      </div>
    );
  }
  ...
  const keyThinkers = philosophersData.filter(p => idea.keyThinkers.includes(p.id));
  const relatedIdeas = ideasData.filter(i => idea.relatedIdeas.includes(i.id));
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <h1 className="text-4xl font-bold text-gray-800 mb-4">{idea.name}</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {originSchool && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Origin School</h2>
                <Link
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    ></div>
                    <h3 className="font-semibold text-gray-800">{originSchool.name}</h3>
                  </div>
                  <p className="text-sm text-gray-600">{originSchool.description}</p>
                </Link>
              </div>
            )}
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {keyThinkers.map((thinker) => (
                  ...
                  >
                    <h3 className="font-semibold text-gray-800 mb-1">{thinker.name}</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Modern Applications</h2>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800">What It Challenged</h2>
              </div>
          ...
          <div className="space-y-6">
            ...
            {relatedIdeas.length > 0 && (
              <div className="bg-white rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-bold text-gray-800 mb-4">Related Ideas</h3>
                <div className="space-y-3">
                  {relatedIdeas.map((relatedIdea) => (
                    ...
                    >
                      <div className="font-medium text-gray-800">{relatedIdea.name}</div>
                      <div className="text-sm text-gray-600 mt-1 line-clamp-2">{relatedIdea.description}</div>
                    </Link>
                  ))}
                </div>
              </div>
